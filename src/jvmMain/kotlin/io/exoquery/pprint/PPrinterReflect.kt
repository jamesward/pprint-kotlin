...
class PPrinterReflect(override val config: PPrinterConfig = PPrinterConfig()): PPrinterBase<Any?>(config) {
  ...
  companion object {
    val Color = PPrinterReflect(PPrinterConfig())
    val BlackWhite = PPrinterReflect(
      PPrinterConfig().copy(
